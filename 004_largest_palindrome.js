...
console.log('Exercise 4 - largest palindrome is: ' +
    findPalindrome(1000));
...
function reverseNumber(_value) {
    ...
    //split the value into an array, reverse it, and join it back together
    // typecast it as a number and set to reversedNum var
    reversedNum = Number(((stringVal.split('')).reverse()).join(''));
    return reversedNum;
}
